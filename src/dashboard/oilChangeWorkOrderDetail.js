...
const OilChangeWorkOrderDetail = ({ value, returnWorkOrderDetail, onDashboardDueDaysInspection }) => {
    ...
    const handleUpdateTotal = async (index, total, labor, qty, parts) => {
        ...
        await updateDoc(doc(db, 'OilChangeWorkOrders', selectedWorkOrder.id.toString()), {
    ...
    const updateComment = async () => {
        ...
        const dbRef = doc(db, 'OilChangeWorkOrders', selectedWorkOrder.id.toString())
    ...
    const updatePendingWOStatus = async () => {
        ...
        await updateDoc(doc(db, 'Assets', selectedWorkOrder.assetNumber.toString()), {
            'oilChangeWorkOrder': selectedWorkOrder.id,
            'LastOil' : completionMileage
        })
    }
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <View style={[styles.newContentCardStyle]}>
                                ...
                                <View style={styles.subViewStyle}>
                                    ...
                                    <Text style={{}}>{selectedWorkOrder.mileage ? selectedWorkOrder.mileage : 'n/a'}</Text>
                                </View>
                                ...
                                <View
                                    ...
                                    <TouchableOpacity
                                        onPress={async () => {
                                            ...
                                            setLoading(true)
                                            await deleteDoc(doc(db, "OilChangeWorkOrders", selectedWorkOrder.id.toString()));
                                            await updateDoc(doc(db, 'Assets', selectedWorkOrder.assetNumber.toString()), {
                                                'oilChangeWorkOrder' : 'not issued',
                                            })
                                            console.log('deleted')
...
export default OilChangeWorkOrderDetail